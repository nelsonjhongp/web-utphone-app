...
CREATE DATABASE IF NOT EXISTS `bdutphone` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `bdutphone`;
...
('C0001', 'Lopez', 'Garcia', 'Marias', 'maria@email.com', '987654321', 1, '123456789'),
...
INSERT INTO `productos` (`id_producto`, `nombre`, `descripcion`, `precio_uni`, `stock`, `id_cate`) VALUES
(1, 'Samsung Galaxy S21', 'El Samsung Galaxy S21 es un teléfono inteligente Android de alta gama con una pantalla brillante y una cámara de primera calidad.', 799.99, 100, 1),
(2, 'iPhone 13 Pro', 'El iPhone 13 Pro de Apple es el último buque insignia con un potente chip A15 Bionic y una excelente cámara Pro.', 999.99, 75, 1),
(3, 'Google Pixel 6', 'El Google Pixel 6 es conocido por su calidad de cámara excepcional y una experiencia de Android pura.', 699.99, 50, 1),
(4, 'OnePlus 9', 'El OnePlus 9 es un teléfono Android potente con una pantalla suave y una carga rápida.', 649.99, 60, 1),
(5, 'Xiaomi Redmi Note 10', 'El Xiaomi Redmi Note 10 es un teléfono económico con una gran pantalla y una duración de batería impresionante.', 249.99, 120, 1),
(6, 'Samsung Galaxy Tab S7', 'La Samsung Galaxy Tab S7 es una tableta Android de alta gama con una pantalla AMOLED y potencia de procesamiento.', 499.99, 30, 2),
(7, 'iPad Air 4', 'El iPad Air 4 de Apple combina rendimiento y portabilidad con su chip A14 y diseño delgado.', 599.99, 40, 2),
(8, 'Amazon Echo Dot', 'El Amazon Echo Dot es un altavoz inteligente con Alexa que ofrece control de voz y música en streaming.', 49.99, 150, 3),
(9, 'JBL Charge 4', 'El JBL Charge 4 es un altavoz Bluetooth portátil con una batería de larga duración y sonido potente.', 119.99, 80, 3),
(14, 'Apple iPhone 14 PRO', 'El iPhone 14 Pro es la versión “profesional” del iPhone 14, ¡y ahora puedes comprarlo al mejor precio! Este móvil te ofrece varias características técnicas destacables entre los celulares Apple.', 4099.00, 10, 1),
(15, 'Galaxy S22 Ultra', 'El Samsung Galaxy S22 Ultra con capacidad 5G es la mayor propuesta de los celulares Samsung para este 2022.', 4199.00, 10, 1),
(16, 'EarPods con conector Apple', 'Los EarPods Lightning de Apple son audifonos con conector lightning que destacan por su calidad de reproducción del audio.', 95.00, 25, 3),
(17, 'Adaptador de corriente USB - C DE 20W Apple', 'El adaptador de pared de Apple tiene potencia para alcanzar una conexión de 20W de carga, lo cual permitirá a tus dispositivos Iphone cargar de una forma muy rápida. Totalmente compatible con cable de carga USB tipo C (se vende por separado).', 89.00, 15, 2),
(18, 'Adaptador I2Go 20W Usb-C Bl', 'El nuevo cargador es compatible con dispositivos PD hasta 20W.', 50.00, 20, 2);
